...
local user_opts = {
    ...
    scalewindowed = 3,       -- scaling of the controller when windowed
    scalefullscreen = 3,     -- scaling of the controller when fullscreen
...
local osc_styles = {
    ...
    seekbar_fg = "{\\blur0\\bord5\\1c&H0000FF}",
...
function layouts()
    ...
    lo.geometry = {x = refX, y = refY - 64, an = 5, w = osc_geo.w - 40, h = 15}
    lo.style = osc_styles.seekbar_fg
    lo.slider.gap = 5
    lo.slider.pad = 0
    lo.slider.handle_size = 0
